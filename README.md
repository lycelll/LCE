...
You should already have the LegacyCrossPlayt folder extracted, if you dont, go back to the repo and follow its instructions. Then, go into the "constants.js" file in the folder and edit one of the IP's in the const SERVERS = {} area (it should look like this) <img width="577" height="244" alt="image" src="https://github.com/user-attachments/assets/e82d5445-89a6-42c2-8aa9-20a722afa301" /> to your custom IP.
